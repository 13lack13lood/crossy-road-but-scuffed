...
public class Main {
	...
	public static void main(String[] args) {
		...
		InstructionMenu instructionMenu = new InstructionMenu(new ImageIcon("res/filmore.png"),new ImageIcon("res/W.png"), new ImageIcon("res/S.png"), new ImageIcon("res/D.png"), new Font("Comic Sans MS", Font.BOLD, 25));
