...
public class TerrainGenerator {
	...
	private Terrain generateNewTerrain() {
		...
		ArrayList<Terrain> terrains = new ArrayList<Terrain>(Arrays.asList(new Grass(Tools.GRASS, Frame.WIDTH / Frame.SQUARE - 1), new Water(Tools.WATER, Frame.WIDTH / Frame.SQUARE - 1), new Road(Tools.ROAD, Frame.WIDTH / Frame.SQUARE - 1), new TrainTrack(Tools.ROAD, Frame.WIDTH / Frame.SQUARE - 1)));
